  ...
  return (
    <section className="relative min-h-[60vh] bg-black flex items-center justify-center px-4 pt-32 pb-16 overflow-hidden">
      ...
      >
        ...
        >
          Contact <span className="text-transparent bg-clip-text bg-linear-to-r from-green-400 to-green-500">Us</span>
        </motion.h1>
        ...
        >
          Have questions atau ingin terlibat? We'd love untuk hear from you.
        </motion.p>
      </motion.div>
