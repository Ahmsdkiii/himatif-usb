          ...
          <div className="flex items-center justify-between h-20">
            ...
            <nav className="hidden md:flex items-center space-x-1">
              ...
              <div className="relative group">
                ...
                <div className="absolute left-0 mt-2 w-64 bg-black/95 backdrop-blur-md rounded-xl border border-green-500/20 shadow-xl shadow-green-500/10 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 transform origin-top scale-95 group-hover:scale-100 z-50">
                  <div className="py-2">
