...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-black border-t border-green-500/20 mt-20">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12 mb-12">
          ...
          <div className="lg:col-span-4">
            <Link href="/" className="inline-block group mb-4">
              <div className="relative">
                <div className="font-bold text-3xl text-green-400 tracking-tight transition-all duration-300 group-hover:text-green-300">
                  HIMATIF USB
                </div>
            ...
            <div className="flex items-start gap-3 text-sm text-gray-400 group hover:text-green-400 transition-colors duration-200">
          ...
          <div className="lg:col-span-2">
            <h4 className="font-semibold text-white text-base mb-4 flex items-center gap-2">
              Quick Links
              <div className="h-px grow bg-linear-to-r from-green-500/50 to-transparent"></div>
            </h4>
            <ul className="space-y-3">
              {quickLinks.map((link) => (
                <li key={link.href}>
                  <Link 
                    href={link.href}
                    className="text-gray-300 text-sm hover:text-green-400 transition-colors duration-200 flex items-center gap-2 group"
                  >
          ...
          <div className="lg:col-span-4">
            ...
            <div className="space-y-4">
              <a 
                ...
                className="flex items-center gap-3 text-gray-300 text-sm hover:text-green-400 transition-colors duration-200 group"
              >
              ...
              <div className="pt-2">
                <p className="text-xs text-gray-400 mb-3">Follow us on social media</p>
                  ...
                  {socialLinks.map((social) => {
                    ...
                    return (
                      <a
                        ...
                        className={`p-2.5 rounded-lg bg-green-500/10 text-gray-300 hover:bg-green-500/20 ${social.color} transition-all duration-200 hover:scale-110 active:scale-95`}
                      >
        ...
        <div className="relative">
          <div className="absolute inset-0 bg-linear-to-r from-transparent via-green-500/20 to-transparent h-px"></div>
          <div className="pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex flex-wrap justify-center gap-6 text-sm">
              <Link 
                href="/privacy" 
                className="text-gray-400 hover:text-green-400 transition-colors duration-200 flex items-center gap-1 group"
              >
                Privacy Policy
      ...
      <div className="absolute bottom-0 left-0 right-0 h-1 bg-linear-to-r from-transparent via-green-500/50 to-transparent"></div>
    </footer>
  )
}