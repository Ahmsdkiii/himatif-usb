  ...
  const divisions: Division[] = [
    {
      ...
      slug: 'inti',
      description:
        'Struktur kepengurusan utama yang mengarahkan, mengoordinasikan, dan mengawasi seluruh jalannya organisasi HIMATIF.',
      responsibilities: [
        'Menjalankan mandat hasil Rapat Kerja Pengurus',
        'Mengambil kebijakan organisasi yang strategis',
    ...
    },
    {
      ...
      slug: 'hrdo',
      description:
        'Mengembangkan kapasitas dan potensi anggota melalui program pelatihan, pendampingan, dan pembentukan karakter.',
      responsibilities: [
        'Mengelola program pelatihan dan pengembangan SDM',
        'Mengatur rekrutmen serta orientasi anggota baru',
        'Membangun budaya organisasi yang positif',
        'Melakukan evaluasi kinerja dan sistem umpan balik',
      ],
      icon: GraduationCap,
      color: 'text-blue-400',
    ...
    },
    {
      ...
      description:
        'Mengelola program akademik dan kegiatan riset untuk meningkatkan kualitas serta kompetensi teknis anggota.',
      responsibilities: [
        'Menyelenggarakan workshop dan pelatihan teknis',
        'Mengkoordinasikan proyek riset dan publikasi',
        'Memfasilitasi mentoring dan kelompok belajar',
        'Menghubungkan anggota dengan peluang akademik',
      ],
      icon: Lightbulb,
    ...
    },
    {
      ...
      description:
        'Mengelola komunikasi eksternal, memperkuat citra organisasi, serta membangun relasi dengan berbagai pihak.',
      responsibilities: [
        'Mengelola media sosial dan identitas digital HIMATIF',
        'Mengkoordinasikan promosi acara dan kebutuhan branding',
        'Mengelola relasi media serta publikasi informasi',
        'Membangun kerja sama dengan organisasi eksternal',
      ],
      icon: Megaphone,
      color: 'text-pink-400',
    ...
    },
    {
      ...
      description:
        'Mengelola kebutuhan kreatif organisasi, pengembangan bisnis, serta program yang mendukung kemandirian dana.',
      responsibilities: [
        'Membuat aset desain dan materi promosi',
        'Mengelola kerja sama bisnis dan sponsorship',
        'Mengkoordinasikan merchandise serta pengembangan produk',
        'Membangun sumber pemasukan yang berkelanjutan',
      ],
      icon: Briefcase,
            ...
            >
              ...
              <div className="relative z-10">
                <div className="flex items-start gap-6 mb-6">
                  <div
                    className={`inline-flex items-center justify-center w-20 h-20 ${intiDivision.bgColor} rounded-2xl border-2 ${intiDivision.borderColor} group-hover:scale-110 transition-transform duration-300`}
                  >
            ...
            return (
              ...
              >
                <Link href={`/divisions/${division.slug}`} className="block">
                  ...
                  <div className="relative z-10">
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex items-center gap-4">
                        <div
                          className={`inline-flex items-center justify-center w-14 h-14 ${division.bgColor} rounded-xl border ${division.borderColor} group-hover:scale-110 transition-transform duration-300`}
                        >
                    ...
                    <div className="mb-6">
                      ...
                      <ul className="space-y-2">
                        {division.responsibilities.map((responsibility, index) => (
                          <li
                            key={index}
                            className="flex gap-3 items-start text-sm group/item"
                          >
                  ...
                  <div
                    className={`absolute -bottom-12 -right-12 w-32 h-32 ${division.bgColor} rounded-full blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500`}
                  ></div>
                </Link>
              </motion.div>
            )
