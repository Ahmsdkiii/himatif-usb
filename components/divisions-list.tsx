          ...
          {divisions.map((division) => {
            ...
            return (
              <motion.div
                ...
                className={`group relative bg-card/40 backdrop-blur-sm border ${division.borderColor} rounded-2xl p-8 hover:border-primary/40 transition-all duration-300 overflow-hidden`}
              >
